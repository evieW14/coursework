...
public class Menu {
    ...
    //handles pringitng out the menu options to the user and allows them to select an option (1-5), the action is performed and the user is asked if they would like to continue -
