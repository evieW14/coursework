...
public class MenuTest {
    ...
    @Test
    public void testUpdateMatchMatchDay1AlreadyComplete() throws IOException {
        provideInput("1");
    ...
    @Test
    public void testUpdateMatchMatchDayNotFound() throws IOException {
        String otherOutputs = "4. Match Update\nWhat Matchday do you want to update?";
        provideInput("14");
        menuTest.optUpdateMatch();
